...
import (
	...
	iddomain "github.com/everactive/dmscore/iot-identity/domain"
...
func (m *MockManage) GetUser(username string) (domain.User, error) {
	...
	return domain.User{Username: testUserName, Name: "JJ", Role: testRole}, nil
}
...
func (m *MockManage) OrganizationGet(orgID string) (domain.Organization, error) {
	...
	return domain.Organization{OrganizationID: testOrg, Name: "Example Org"}, nil
}
...
func (m *MockManage) OrganizationForUserToggle(orgID, username string) error {
	if orgID != "abc" || username != testUserName {
